...
from .views import home, T1_Stock, T2_Employees, T3_Dashboard, T4_Settings, CustomLoginView, T2_Employees_List, T2_Employees_Edit, T2_Employees_Delete, T1_Producto, T1_Categoria, T1_Proveedor, T1_edit_proveedor, eliminar_proveedor, T1_Edit_Categoria, eliminar_categoria, T1_Edit_Producto, eliminar_producto, update_product_quantity

urlpatterns = [
    path('', RedirectView.as_view(url='/accounts/login/', permanent=False)),
    path('accounts/login/', CustomLoginView.as_view(), name='login'),  # Usar la vista personalizada
    path('home/', home, name="home"),
    path('T1_Stock/', T1_Stock, name="T1_Stock"),
    ...
    path('T1_Proveedor/', T1_Proveedor, name='T1_Proveedor'),
     path('T1_edit_proveedor/editar/<int:proveedor_id>/', T1_edit_proveedor, name='editar_proveedor'),
    path('T1_edit_proveedor/eliminar/<int:proveedor_id>/', eliminar_proveedor, name='eliminar_proveedor'),
    # Rutas empleados
