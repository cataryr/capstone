document.addEventListener('DOMContentLoaded', function () {
    ...
    function renderTable(filteredData = stockData) {
        ...
        filteredData.forEach((item, index) => {
            ...
            if (!item.redAlertShown && item.cantidad <= 5) {
                showModal("Cuidado nos estamos quedando sin nem", 'red');
                ...
                showModal("Deberíamos de administrar mejor nuestros recursos", 'orange');
    ...
    function showModal(message, type) {
        if (type === 'red') {
            ...
            modalImage.src = './img/nezuko.png'; // Ruta de la imagen para alerta naranjo
        }
